...
-- Token can be exchanged even if it not used to pay transaction feee
-- Limited: can only be spent if funded no more than half of value of deposited tokens (calculated by datum exchange rate)
